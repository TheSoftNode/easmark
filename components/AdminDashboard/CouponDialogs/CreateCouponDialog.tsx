...
//                             type="text"
//                             placeholder={
//                               form.watch('coupon_type') === 'percentage' ? 'Enter percentage' :
//                               form.watch('coupon_type') === 'fixed' ? 'Enter amount' :
//                               'Enter number of analyses'
//                             }
//                             {...field}
//                             className="focus-visible:ring-violet-500"
//                           />
...
//                         showTimeSelect
//                         dateFormat="Pp"
//                         className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus:ring-2 focus:ring-violet-500"
