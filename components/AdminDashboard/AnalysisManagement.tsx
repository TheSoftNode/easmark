...
//                 <div>
//                     <h1 className="text-2xl font-bold text-gray-900">Analysis Types</h1>
...
//                     </CardHeader>
//                     <CardContent>
//                         <div className="text-2xl font-bold">{analysisTypes?.length || 0}</div>
//                         <p className="text-xs text-gray-500 mt-1">Active analysis types</p>
//                     </CardContent>
//                 </Card>
//             </div>
...
//                     <DialogHeader>
//                         <DialogTitle>Create Analysis Type</DialogTitle>
//                         <DialogDescription>
...
//                                         <FormControl>
//                                             <Input placeholder="Enter analysis type name" {...field} />
//                                         </FormControl>
//                                         <FormMessage />
//                                     </FormItem>
//                                 )}
...
//                                 render={({ field }) => (
//                                     <FormItem>
//                                         <FormLabel>Base Cost (Credits)</FormLabel>
//                                         <FormControl>
//                                             <Input
//                                                 type="number"
//                                                 placeholder="0"
